...
const uzumCheckUser = (req, res, next) => {
    console.log("Uzum user check: ok");
    next(); // Keyingi bosqichga o'tishi uchun buni unutmaslik kerak
};

module.exports = {uzumCheckToken,uzumCheckUser}