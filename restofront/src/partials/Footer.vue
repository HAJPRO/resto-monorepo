...
const navLinks = [
  ...
  { tab: 'cash', label: 'Kassa', url: '/explore/cash', icon: walletOutline, activeIcon: walletOutline,role:[1000,2000] },
  { tab: 'order', label: 'Buyurtmalar', url: '/explore/order', icon: receiptOutline, activeIcon: receipt,role:[1000,2000] },
  { 
  tab: 'statistic', 
  label: 'Statistika', 
  ...
  role: [1000, 2000]  // Aktiv holatda to'qroq grafik
},
];
